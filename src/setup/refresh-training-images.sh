...
gsutil cp gs://roman-test-oct9-images-for-training-v-45/* ./
...
gsutil cp provided-images.zip gs://robot-derby-io-images

rm provided-images.zip

echo "Make a backup copy of training images..."
NOW=`date +%Y-%m-%d-%H-%M-%S`
gsutil cp gs://robot-derby-io-images/provided-images.zip gs://robot-derby-backup/${NOW}-provided-images.zip
