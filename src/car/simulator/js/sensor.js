...
let data = [
  { "car": 1, "laser": 90, "balls": 0, "battery": 99, "color": "Blue" },
  { "car": 1, "laser": 80, "balls": 0, "battery": 90, "color": "Blue" },
  { "car": 1, "laser": 70, "balls": 0, "battery": 85, "color": "Blue" },
  { "car": 1, "laser": 60, "balls": 1, "battery": 80, "color": "Blue" },
  { "car": 1, "laser": 50, "balls": 1, "battery": 75, "color": "Blue" },
  { "car": 1, "laser": 40, "balls": 1, "battery": 70, "color": "Blue" },
  { "car": 1, "laser": 30, "balls": 2, "battery": 65, "color": "Blue" },
  { "car": 1, "laser": 20, "balls": 2, "battery": 60, "color": "Blue" },
  { "car": 1, "laser": 11, "balls": 2, "battery": 55, "color": "Blue" },
  { "car": 1, "laser": 10, "balls": 3, "battery": 50, "color": "Blue" },
];
...
function sendOneMessage() {
  ...
  let message = JSON.stringify(
    new SensorMessage(data[i].car, data[i].balls, data[i].battery, data[i].timeLeft, data[i].laser, imageUrl, data[i].color));
