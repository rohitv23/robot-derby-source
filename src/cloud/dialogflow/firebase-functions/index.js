...
let COMMAND_TOPIC = 'driving-commands-topic-2';
...
//const subscriptionName = 'projects/talk-to-your-robot/subscriptions/test';
const timeout = 3000;
//const read_subscription = pubsub.subscription(subscriptionName);
...
function callVision (vision) {
    return new Promise((resolve, reject) => {
        ...
        /*if (vision == 'read'){
            console.log(`set subscription to: ${subscriptionName}`);
            read_subscription = pubsub.subscription(subscriptionName);
        } else if (vision == 'translate'){
            subscriptionName = 'projects/talk-to-your-robot/subscriptions/translate';
            read_subscription = pubsub.subscription(subscriptionName);
        }*/
        ...
        setTimeout(() => {
            ...
            for (var i = 0; i < global.messages.length; i++) { 
                ...
                //var message = Buffer.from(global.messages[i].data, 'base64').toString();
